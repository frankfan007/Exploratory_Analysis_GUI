function varargout = Exploratory_Data_Analysis_GUI_v01(varargin)
% EXPLORATORY_DATA_ANALYSIS_GUI_V01 MATLAB code for Exploratory_Data_Analysis_GUI_v01.fig
%      EXPLORATORY_DATA_ANALYSIS_GUI_V01, by itself, creates a new EXPLORATORY_DATA_ANALYSIS_GUI_V01 or raises the existing
%      singleton*.
%
%      H = EXPLORATORY_DATA_ANALYSIS_GUI_V01 returns the handle to a new EXPLORATORY_DATA_ANALYSIS_GUI_V01 or the handle to
%      the existing singleton*.
%
%      EXPLORATORY_DATA_ANALYSIS_GUI_V01('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EXPLORATORY_DATA_ANALYSIS_GUI_V01.M with the given input arguments.
%
%      EXPLORATORY_DATA_ANALYSIS_GUI_V01('Property','Value',...) creates a new EXPLORATORY_DATA_ANALYSIS_GUI_V01 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Exploratory_Data_Analysis_GUI_v01_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Exploratory_Data_Analysis_GUI_v01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Exploratory_Data_Analysis_GUI_v01

% Last Modified by GUIDE v2.5 25-Aug-2017 16:43:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Exploratory_Data_Analysis_GUI_v01_OpeningFcn, ...
                   'gui_OutputFcn',  @Exploratory_Data_Analysis_GUI_v01_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Exploratory_Data_Analysis_GUI_v01 is made visible.
function Exploratory_Data_Analysis_GUI_v01_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Exploratory_Data_Analysis_GUI_v01 (see VARARGIN)
...
% Choose default command line output for Exploratory_Data_Analysis_GUI_v01
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Exploratory_Data_Analysis_GUI_v01 wait for user response (see UIRESUME)
...
Index_Final =  Index2 & Index_Date1 & Index_Date2;
ytemp2 = ytemp1(Index_Final);

pos = event_obj.Position;
Xcoord = event_obj.Target.XData';
Ycoord = event_obj.Target.YData';
[~,idx] = ismember(pos,[Xcoord Ycoord],'rows');
Ydata = event_obj.Target.CData(idx);
idx_reduce = UserData.index_reduce;
idx_data = idx_reduce == idx;
...
%
Index_Final =  Index2 & Index_Date1 & Index_Date2 & Index_Axis;
...
function varargout = Exploratory_Data_Analysis_GUI_v01_OutputFcn(hObject, eventdata, handles) 
...
hold off
scatter(ull(:,1),ull(:,2),MarkerSize,y_reduce,'filled',shape);
